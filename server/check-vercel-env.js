...
const checkVercelEnv = async () => {
  try {
    console.log('Checking Vercel deployment environment variables...');
    ...
    try {
      ...
      console.log('Deployment environment variables:', stdout);
    } catch (error) {
      console.error('Error checking deployment environment variables:', error);
    }
  } catch (error) {
    console.error('Error checking Vercel deployment environment variables:', error);
  }
};
